...
- Avg first crash: 5.2s
- Median first crash: 4.7s
- Avg traffic waves: 5.4
- Avg near misses: 1.0
- Avg cash: 7
- Autoplay decisions: 171
- Autoplay move decisions: 22
- Autoplay target mismatches: 70
- Autoplay move-target mismatches: 3
- Autoplay applied-slot mismatches: 3
...
- Autoplay decision statuses: {'already_at_target': 90, 'move': 22, 'no_reachable_slots': 59}

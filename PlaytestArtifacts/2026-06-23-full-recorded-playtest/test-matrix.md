...
| FUNC-10 | Background and relaunch restoration | iPhone 17e | partial | `videos/progression/2026-06-23_iphone17e_existing-save_relaunch-restoration-clean_session02.mp4` | | App termination and relaunch restored to the Los Angeles start screen with high score 741, cash `$443`, and Sunset Cruiser visible. OS background/foreground behavior is still not tested, and debug auto-start defaults had to be cleaned after capture. |

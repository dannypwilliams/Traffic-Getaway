...
First-minute reliability, deterministic-core repair, live telemetry, live lane-change transition diagnosis, active-traffic diagnostic calibration, first-escape payoff evidence, manual-capture tooling, and full recorded playtest setup: partial. Tightened debug autoplay now clears the sampled iPhone 17e first minute, Dynamic Island debug autoplay is improved but not locked, the Starter Bike result-screen payoff and `USE BIKE` tap-through into 405 Afterburn are smoke-validated, start-gated manual capture tooling is ready, the full recorded playtest artifact root has twelve valid active-input samples across the completed iPhone 17e LA slices, one iPhone 17 Pro Dynamic Island sample, and one existing-save Level Select-to-LA sample, fresh-install tutorial completion has recorded evidence, and GameSim's opt-in active-traffic lifetime diagnostic has moved toward live evidence but remains too punitive for balance.
...
- `scripts/capture_live_telemetry.py`: added `--control-preference` for future `SWIPE + TAP`, `SWIPE ONLY`, and `TAP ONLY` manual coverage, clears stale debug result scenarios during setup, and restarts simulator preference caching around save writes.
...
- Full recorded playtest current counts: planned tests 73, passed 20, failed 3, partial 22, not tested 28, valid active-input runs 12, invalid runs 6.
...
- Full recorded playtest Dynamic Island evidence: active iPhone 17 Pro Run 02 video `videos/dynamic-island/2026-06-23_iphone17pro_la01_starter-compact_vehicle-mismatch_swipe-tap_dynamic-island_run02.mp4`, raw telemetry `telemetry/raw/01-2026-06-23_09-51-27-la_01-starter_compact-17033032432948438445.jsonl`, summary `telemetry/summaries/2026-06-23_iphone17pro_la01_starter-compact_vehicle-mismatch_swipe-tap_dynamic-island_run02-summary.md`, screenshots under `screenshots/dynamic-island/`, and observations `logs/2026-06-23_iphone17pro_la01_dynamic-island_run02-observations.md`.
- Full recorded playtest Dynamic Island aggregate: one valid active-input iPhone 17 Pro sample, 0/1 completed, terminal traffic collision at 23.7s, 5 near misses, 2 lane changes, 49 cash, wanted level 3, 0 autoplay decisions, collision analysis present. Dynamic Island Run 01 is rejected from active-input coverage because telemetry recorded 0 lane changes.
- Full recorded playtest P2 issue: `FTG-P2-001` documents that the Dynamic Island overlaps/clips the top gameplay HUD on iPhone 17 Pro, with 2/2 Dynamic Island samples showing the top-HUD safe-area problem.
- Full recorded playtest P2 issue: `FTG-P2-002` documents that the iPhone 17 Pro manual capture had inconsistent vehicle identity: requested Starter Bike, telemetry `starter_compact`, visible UI/result Sunset Cruiser.
- Full recorded playtest fresh-install tutorial/progression evidence: video `videos/progression/2026-06-23_iphone17e_fresh-install_tutorial-la-progression_attempt01.mp4`, tutorial screenshots under `screenshots/tutorial/2026-06-23_iphone17e_fresh-install_tutorial-progression_attempt01_*.png`, result screenshot `screenshots/progression/2026-06-23_iphone17e_fresh-install_tutorial-la-progression_attempt01_result-captured.png`, telemetry `telemetry/raw/01-2026-06-23_10-02-16-la_01-starter_compact-fresh-install-progression-17033032432948192956.jsonl`, summary `telemetry/summaries/2026-06-23_iphone17e_fresh-install_tutorial-la-progression_attempt01-summary.md`, and observations `logs/2026-06-23_iphone17e_fresh-install_tutorial-la-progression_attempt01-observations.md`.
- Full recorded playtest fresh-install result: onboarding pages 1-5 completed without skip and transitioned into `la_01`; gameplay ended as `police_caught` at 9.0s with 0 lane changes, 0 near misses, 12 cash, wanted level 3, and 0 autoplay decisions. This is valid tutorial/progression-flow evidence but invalid for active-run, balance, fairness, and complete city-progression coverage.
- Full recorded playtest existing-save Level Select-to-LA active progression evidence: video `videos/progression/2026-06-23_iphone17e_existing-save_level-select-la01_active-progression_attempt02.mp4`, screenshots `screenshots/progression/2026-06-23_iphone17e_existing-save_level-select-la01_active-progression_attempt02_city-select.png`, `..._start-screen.png`, and `..._result-crashed.png`, telemetry `telemetry/raw/01-2026-06-23_10-17-12-la_01-starter_compact-existing-save-active-progression-17033032432948208794.jsonl`, summary `telemetry/summaries/2026-06-23_iphone17e_existing-save_level-select-la01_active-progression_attempt02-summary.md`, and observations `logs/2026-06-23_iphone17e_existing-save_level-select-la01_active-progression_attempt02-observations.md`.
- Full recorded playtest existing-save Level Select-to-LA result: City Select / Level Select was captured from the failure result screen, LA01 launched from the visible start gate, telemetry recorded 3 lane changes and 3 near misses with 0 autoplay decisions, and the run ended as a traffic collision at 8.5s. Result screen showed `Level 1 -> 2`. This is valid active-input progression/navigation evidence, but not complete Los Angeles city progression.
- Full recorded playtest existing-save LA01 progression attempt 03 evidence: video `videos/progression/2026-06-23_iphone17e_existing-save_la01_active-progression_attempt03.mp4`, screenshots `screenshots/progression/2026-06-23_iphone17e_existing-save_la01_active-progression_attempt03_start-screen.png` and `..._result-captured.png`, telemetry `telemetry/raw/01-2026-06-23_10-24-45-la_01-starter_compact-existing-save-active-progression-attempt03-17033032432948216713.jsonl`, summary `telemetry/summaries/2026-06-23_iphone17e_existing-save_la01_active-progression_attempt03-summary.md`, and observations `logs/2026-06-23_iphone17e_existing-save_la01_active-progression_attempt03-observations.md`.
- Full recorded playtest existing-save LA01 progression attempt 03 result: telemetry recorded 0 lane changes, 0 active-input runs, terminal `police_caught` at 9.0s, 0 near misses, 12 telemetry cash, and 0 autoplay decisions. Result screen showed `CAPTURED`, 356 score, 314 distance, `$71`, 60 XP, wanted level 3, and Level 2 progress. This is invalid for active-run, fairness, balance, and complete city-progression coverage.
- Full recorded playtest Garage/vehicle-selection session 01 evidence: video `videos/progression/2026-06-23_iphone17e_existing-save_garage-vehicle-selection_session01.mp4`, screenshots `screenshots/progression/2026-06-23_iphone17e_existing-save_garage-vehicle-selection_session01_current-car.png`, `..._locked-bike.png`, and `..._menu-return.png`, and observations `logs/2026-06-23_iphone17e_existing-save_garage-vehicle-selection_session01-observations.md`.
- Full recorded playtest Garage/vehicle-selection session 01 result: Garage opened from the result screen, selected `SUNSET CRUISER` was visible on Cars, Bikes tab showed `STARTER BIKE` with `NEED $107 MORE`, and Back returned to the main menu. This is partial vehicle-selection coverage because it proves Garage browsing and locked-vehicle messaging, but not selecting an alternate unlocked vehicle.
- Full recorded playtest relaunch/save-restoration evidence: initial video `videos/progression/2026-06-23_iphone17e_existing-save_relaunch-restoration_session01.mp4`, clean cycle video `videos/progression/2026-06-23_iphone17e_existing-save_relaunch-restoration-clean_session02.mp4`, screenshots `screenshots/progression/2026-06-23_iphone17e_existing-save_relaunch-restoration_session01_before-terminate.png`, `..._after-relaunch-start-screen.png`, `..._clean_session02_before-terminate.png`, and `..._clean_session02_after-relaunch.png`, cleanup logs under `build-validation/relaunch-restoration-debug-defaults-*.log`, and observations `logs/2026-06-23_iphone17e_existing-save_relaunch-restoration_session01-observations.md`.
- Full recorded playtest relaunch/save-restoration result: termination and relaunch restored high score 741, cash `$443`, selected `SUNSET CRUISER`, and Los Angeles start context. It is partial for background/relaunch because OS background/foreground was not tested, and partial for existing-save progression restoration because the richer Level 2 XP main-menu state was visible before termination but not after relaunch. Final cleanup removed debug auto-start keys while preserving `TrafficGetaway.SaveData.v2`.
- Full recorded playtest background/foreground evidence: video `videos/progression/2026-06-23_iphone17e_existing-save_background-foreground_session01.mp4`, screenshots `screenshots/progression/2026-06-23_iphone17e_existing-save_background-foreground_session01_before-home.png`, `..._actual-home-screen.png`, and `..._actual-after-foreground.png`, cleanup log `build-validation/background-foreground-debug-defaults-final-clean-after-capture.log`, and observations `logs/2026-06-23_iphone17e_existing-save_background-foreground_session01-observations.md`.
- Full recorded playtest background/foreground result: Simulator reached the iOS Home screen with the Traffic Getaway icon visible, then foregrounding Traffic Getaway returned to the Los Angeles start screen with high score 741, cash `$443`, and selected `SUNSET CRUISER`. This strengthens `FUNC-10` but remains partial because active-gameplay backgrounding and normal main-menu foreground restoration are not proven.
- Full recorded playtest active-gameplay background/foreground evidence: video `videos/progression/2026-06-23_iphone17e_la01_active-gameplay_background-foreground_session01.mp4`, screenshots `screenshots/progression/2026-06-23_iphone17e_la01_active-gameplay_background-foreground_session01_start-gate.png`, `..._before-home-active.png`, `..._home-screen.png`, `..._after-foreground.png`, and `..._result-captured.png`, telemetry `telemetry/raw/01-2026-06-23_10-46-19-la_01-starter_compact-active-gameplay-background-foreground-17033032432948224632.jsonl`, summary `telemetry/summaries/2026-06-23_iphone17e_la01_active-gameplay_background-foreground_session01-summary.md`, cleanup log `build-validation/active-gameplay-background-foreground-debug-defaults-final-clean-after-capture.log`, and observations `logs/2026-06-23_iphone17e_la01_active-gameplay_background-foreground_session01-observations.md`.
- Full recorded playtest active-gameplay background/foreground result: a run began from the visible start gate, the simulator reached the iOS Home screen during gameplay, foregrounding returned to gameplay/result flow, and the run reached terminal `CAPTURED`. Telemetry recorded 0 lane changes, 0 active-input runs, terminal `police_caught` at 9.0s, and 0 autoplay decisions, so this is functional lifecycle evidence but invalid for active-run, fairness, or balance coverage.
- Full recorded playtest pause/settings probe evidence: video `videos/progression/2026-06-23_iphone17e_la01_pause-settings-probe_session01.mp4`, screenshots `screenshots/progression/2026-06-23_iphone17e_la01_pause-settings-probe_session01_start-settings-visible.png`, `..._start-settings-overlay.png`, `..._active-hud-no-pause-visible.png`, and `..._result-captured.png`, telemetry `telemetry/raw/01-2026-06-23_10-51-46-la_01-starter_compact-pause-settings-probe-17033032432948232551.jsonl`, summary `telemetry/summaries/2026-06-23_iphone17e_la01_pause-settings-probe_session01-summary.md`, and notes `logs/2026-06-23_iphone17e_la01_pause-settings-probe_accessibility-notes.txt`.
- Full recorded playtest pause/settings probe result: pre-game Settings opened and returned with Back, but active gameplay exposed no app-level Pause, Resume, Settings, Back, or Restart control. `FUNC-06` pause/resume and `FUNC-07` restart-after-pause are now failed, logged as `FTG-P2-003`. Telemetry recorded 0 lane changes, 0 active-input runs, terminal `police_caught` at 9.0s, and 0 autoplay decisions, so the probe is functional evidence only and invalid for active-run, fairness, or balance coverage.
- Full recorded playtest debug-first-escape completion/reward evidence: video `videos/progression/2026-06-23_iphone17e_la01_debug-first-escape_completion-reward_session01.mp4`, screenshot `screenshots/progression/2026-06-23_iphone17e_la01_debug-first-escape_completion-reward_session01_results-use-bike.png`, cleanup log `build-validation/debug-first-escape-completion-reward-debug-defaults-final-clean-after-capture.log`, and observations `logs/2026-06-23_iphone17e_la01_debug-first-escape_completion-reward_session01-observations.md`.
- Full recorded playtest debug-first-escape completion/reward result: the real result UI showed `ESCAPED`, `$423`, `213 XP`, `Level 1 -> 2`, `Starter Bike unlocked: split lanes`, and primary `USE BIKE`. `FUNC-09` is now partial, not pass, because the capture used the debug-only synthetic result scenario rather than a real active-input completion and has no raw run telemetry.
...
- Full recorded playtest configured level start-gate evidence: every non-`la_01` Starter Compact level has full-screen video, screenshot, defaults probe log, and cleanup proof. These artifacts are start-screen-only evidence and do not count as active-input city runs, progression, balance, fairness, stress, or completion coverage. The start screen shows city/vehicle, not exact level name, so level-specific proof depends on the probe logs.
- Full recorded playtest manual-input blocker: a `ny_01` / `starter_compact` `--manual --wait-for-start-tap` probe launched and waited for input, but the Mac host session was locked and no Simulator click/steering path was available. Logs are under `PlaytestArtifacts/2026-06-23-full-recorded-playtest/logs/manual-input-blocker/`; no active run was counted and debug defaults were clean afterward.
- Logs:
...
| Full recorded playtest | In progress | Artifact scaffold exists; automated validation passed; LA Starter Compact iPhone 17e slice has five complete-evidence active runs plus one supplemental active run; LA Starter Bike has three complete-evidence active runs; failure/retry functional session is recorded; iPhone 17 Pro Dynamic Island active sample is recorded but failed the top-HUD safe-area check and exposed a vehicle identity mismatch; fresh-install tutorial completion, City Select / Level Select, and configured start gates for every remaining Starter Compact level are recorded; opening New York/Miami slices still have 0 active runs |
...
- P1 milestone blocker: Full recorded playtest is incomplete. Current full-playtest artifact has completed only the Los Angeles Starter Compact and Starter Bike iPhone 17e slices, tutorial completion, City Select / Level Select, failure/retry, one Dynamic Island-class safe-area/control sample, and configured start-gate-only evidence for remaining Starter Compact levels; New York/Miami active runs, complete active progression, pause/backgrounding, and many required videos are still not tested.
...
- P2 presentation defect: iPhone 17 Pro Dynamic Island overlaps/clips the top gameplay HUD (`FTG-P2-001`).
- P2 playtest/tooling validity defect: iPhone 17 Pro manual capture showed requested/visible/telemetry vehicle identity mismatch (`FTG-P2-002`).
...
Continue `PlaytestArtifacts/2026-06-23-full-recorded-playtest/`: first unlock the host session or provide another reliable Simulator input path, then capture a valid longer active Los Angeles progression attempt using an input method that telemetry confirms as lane-changing before relying on the run for active coverage. Separately investigate the Dynamic Island top-HUD overlap and iPhone 17 Pro vehicle identity mismatch before relying on more iPhone 17 Pro vehicle-specific rows, then continue New York/Miami starter-vehicle coverage before retuning Sunset Merge.

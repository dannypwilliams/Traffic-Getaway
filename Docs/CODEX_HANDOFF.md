...
- Full recorded playtest current counts: planned tests 73, passed 16, partial 2, not tested 55, valid active-input runs 9, invalid runs 1.
...
| Full recorded playtest | In progress | Artifact scaffold exists; automated validation passed; LA Starter Compact iPhone 17e slice has five complete-evidence active runs plus one supplemental active run; LA Starter Bike has three complete-evidence active runs; both opening slices are 0% complete in counted active play |

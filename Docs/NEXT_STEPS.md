...
3. Run `cd GameSim && swift run GameSim --level ny_01 --vehicle starter_compact --runs 10000 --seed 12345`.
4. Also run `cd GameSim && swift run GameSim --level brooklyn_warmup --vehicle starter_compact --runs 10000 --seed 12345`.
5. On Mac, run `Tools/mac/verify_on_mac.sh`.
6. Play Brooklyn Warmup at least 5 times and validate the 42-second exit timing.

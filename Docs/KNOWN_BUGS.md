...
- Sim/live behavior is not reconciled; live telemetry exists, but live autoplay still crashes far earlier than GameSim, now narrowed to lane-change transition timing/path occupancy.
...
- Live lane-change duration/path occupancy and active traffic lifetime are not modeled by GameSim closely enough to explain early live crashes.

...
enum LevelCatalog {
    static let all: [LevelDefinition] = [
        LevelDefinition(levelID: "ny_01", name: "Brooklyn Warmup", city: .newYork, durationBeforeExit: 38, exitSide: .right, exitWindowSeconds: 15, startingTrafficDensity: 0.08, maxTrafficDensity: 0.24, policeAggression: 0.46, rewardCash: 230, rewardXP: 95, allowsEmergencyExit: true),
        LevelDefinition(levelID: "ny_02", name: "FDR Squeeze", city: .newYork, durationBeforeExit: 56, exitSide: .left, exitWindowSeconds: 13, startingTrafficDensity: 0.22, maxTrafficDensity: 0.46, policeAggression: 0.78, rewardCash: 255, rewardXP: 110, allowsEmergencyExit: true),
        LevelDefinition(levelID: "ny_03", name: "Midtown Split", city: .newYork, durationBeforeExit: 66, exitSide: .right, exitWindowSeconds: 12, startingTrafficDensity: 0.3, maxTrafficDensity: 0.57, policeAggression: 0.96, rewardCash: 300, rewardXP: 125, allowsEmergencyExit: true),
        LevelDefinition(levelID: "ny_04", name: "Queensboro Heat", city: .newYork, durationBeforeExit: 74, exitSide: .left, exitWindowSeconds: 10, startingTrafficDensity: 0.36, maxTrafficDensity: 0.65, policeAggression: 1.08, rewardCash: 360, rewardXP: 145, allowsEmergencyExit: false),
        LevelDefinition(levelID: "ny_05", name: "Tunnel Break", city: .newYork, durationBeforeExit: 82, exitSide: .right, exitWindowSeconds: 10, startingTrafficDensity: 0.42, maxTrafficDensity: 0.72, policeAggression: 1.18, rewardCash: 460, rewardXP: 170, allowsEmergencyExit: false),
